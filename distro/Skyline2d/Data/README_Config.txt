# This is a configuration file for Skyline.
# To use it, rename it to Config.txt, otherwise default config will be used.


[AI]

# Adjust the number of enemy missiles here
enemy_num_missiles_easy = 45
enemy_num_missiles_medium = 90
enemy_num_missiles_hard = 180
enemy_num_missiles_insane = 250
enemy_num_missiles_custom = 90

# Enemy time between launches
enemy_time_between_launch_easy = 3.0
enemy_time_between_launch_medium = 2.5
enemy_time_between_launch_hard = 1.75
enemy_time_between_launch_insane = 1.5
...
enemy_missile_exp_radius_easy = 20
...
enemy_launcher_string_easy = 1 0.5
enemy_launcher_string_medium = 2 0.25 0.75
enemy_launcher_string_hard = 3 0.25 0.5 0.75
enemy_launcher_string_insane = 4 0.15 0.35 0.65 0.85
enemy_launcher_string_custom = 2 0.25 0.75
...
player_time_between_launch_easy = 0.25
player_time_between_launch_medium = 0.5
player_time_between_launch_hard = 0.5
player_time_between_launch_insane = 0.75
player_time_between_launch_custom = 0.5
...
player_missile_exp_duration_hard = 2.0
player_missile_exp_duration_insane = 1.0
...
player_laser_color_string_medium = RGB
player_laser_color_string_hard = CMY
player_laser_color_string_insane = CMY
...
player_laser_blend_mode_string_medium = BLEND
...
# Player laser width
player_laser_width_easy = 40
player_laser_width_medium = 30
player_laser_width_hard = 20
player_laser_width_insane = 10
player_laser_width_custom = 30
...
# Depth of shield
player_shield_depth_easy = 50
player_shield_depth_medium = 80
player_shield_depth_hard = 110
player_shield_depth_insane = 150
player_shield_depth_custom = 80
